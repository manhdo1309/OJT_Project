...
if(myCart.length === 0){
    ...
    function renderProductPay(){
        ...
        `
        <td colspan="5">Tổng thanh toán (${myCart.length} sản phẩm): <t style="color: #ee5341; font-size: 130%">${totalPayment.toLocaleString('vi-VN')}đ</t>  <button>Mua hàng</button></td>
